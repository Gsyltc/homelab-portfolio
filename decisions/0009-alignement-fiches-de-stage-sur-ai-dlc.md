...
> Statut **Accepted** — validation humaine explicite obtenue (multica.gaston, 2026-09-03). Le passage à Accepted supposait la validation humaine granulaire et le contrôle sécurité (Reviewer de sécurité) sur la nouvelle surface (vocabulaire de délégation, revue adversariale) ; ces conditions sont satisfaites (invariant respecté : aucun ADR accepté sans validation humaine).
