...
| QA Docker | [qa-docker-agent.md](qa-docker-agent.md) | Vérifie les docker-compose (YAML, Swarm, hardening technique, Traefik) et renvoie les défauts au Spécialiste Docker (contrôle, sans correction). Intervient après création. |
