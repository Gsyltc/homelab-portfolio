...
> **Divergence maison tracée ([ADR-0009](../../../decisions/0009-alignement-fiches-de-stage-sur-ai-dlc.md))** : le compartiment `## Learn` pointe vers la boucle d'apprentissage **maison** (journal candidats-règles sur l'issue → gate → persistance versionnée dans `core/rules/`, voir [ADR-0004](../../../decisions/0004-boucle-apprentissage-et-regles-persistantes.md)), et **non** vers un journal `memory.md` externe (non importé — cohérent avec le choix « conventions Markdown, moteur A2A Multica »).
