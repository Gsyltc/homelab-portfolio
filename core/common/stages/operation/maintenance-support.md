...
Boucle d'apprentissage maison (voir [`core/rules/`](../../../rules/README.md)) : non actif par défaut. À l'activation, ce stage tiendra le journal des candidats-règles et les remontera au gate humain explicite d'Operation, avec persistance dans `core/rules/` via le cycle capture → confirmation humaine → contrôle de conflit.
