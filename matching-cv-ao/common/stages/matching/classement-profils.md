...
Agrégérer les résultats de matching, trier par score décroissant, grouper par recommandation (recommandé / possible / déconseillé).

### Step 2 — Préparation de la présentation
Pour chaque profil, préparer : nom, score total, détail par critère, recommandation, justification. Format Markdown pour l'humain.
